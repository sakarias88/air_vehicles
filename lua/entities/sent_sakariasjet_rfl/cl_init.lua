...
function ENT:EffectDraw_blasma()
		...
		local vOffset = ((self.Entity:GetPos() + self.Entity:GetForward() * -275 + self.Entity:GetUp() * 19) + (self.Entity:GetRight() * 20) + PosFix)
		...
		if thrust != 0 then
			...
			--Added a second beam
			vOffset = ((self.Entity:GetPos() + self.Entity:GetForward() * -275 + self.Entity:GetUp() * 19) + (self.Entity:GetRight() * -20) + PosFix)
