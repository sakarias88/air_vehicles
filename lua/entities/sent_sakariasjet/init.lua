...
--------Spawning the entity and getting some sounds i use.   
 	...
 	local SpawnPos = tr.HitPos + tr.HitNormal * 10 + Vector(0,0,80)
 	 
	local vec = ply:GetAimVector():Angle()
	local newAng = Angle(0,vec.y,0)
 	local ent = ents.Create( "sent_SakariasJet" )
	ent:SetPos( SpawnPos ) 
...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/military2/air/air_f35.mdl")
    ...
    self.Seat:SetPos( self.Entity:GetPos() + ( self.Entity:GetForward() * 80 ) + ( self.Entity:GetUp() * -13 ) )  
	...
	self.LeftMissile:SetPos(self.Entity:GetPos() + (self.Entity:GetRight() * -141) + (self.Entity:GetUp() * -20) + (self.Entity:GetForward() * -150) )
	...
	self.RightMissile:SetPos(self.Entity:GetPos() + (self.Entity:GetRight() * 141) + (self.Entity:GetUp() * -20) + (self.Entity:GetForward() * -150) )
	...
	self.LeftBomb:SetPos(self.Entity:GetPos() + (self.Entity:GetRight() * -189) + (self.Entity:GetUp() * -18) + (self.Entity:GetForward() * -177) )
	...
	self.RightBomb:SetPos(self.Entity:GetPos() + (self.Entity:GetRight() * 189) + (self.Entity:GetUp() * -18) + (self.Entity:GetForward() * -177) )
	...
	self.LeftWingProp:SetPos(self.Entity:GetPos() + (self.Entity:GetRight() * -222) + (self.Entity:GetUp() * -5) + (self.Entity:GetForward() * -230) )
	...
	self.RightWingProp:SetPos(self.Entity:GetPos() + (self.Entity:GetRight() * 222) + (self.Entity:GetUp() * -5) + (self.Entity:GetForward() * -230) )
	...
	self.Stabilizer:SetPos(self.Entity:GetPos())
...
function ENT:Think()
	...
	if self.LandGearOnce == 1 && self.JetHealth > 0 then
		...
		self.Entity:SetModel("models/military2/air/air_f35_l.mdl")
		self.LandGear = CurTime() + 2
	end
	...
	if self.Entity.UseSeat == 1 then
		...
		if self.StartOnce == 0 then
			...
			self.target1:SetPos(self.Entity:GetPos() + (self.Entity:GetRight() * 170) + (self.Entity:GetForward() * -50) ) 
			...
			self.target2:SetPos(self.Entity:GetPos() + (self.Entity:GetRight() * -170) + (self.Entity:GetForward() * -50) )
			...
			self.target3:SetPos((self.Entity:GetPos() + self.Entity:GetForward() * -430 + self.Entity:GetUp() * 19))
			...
			self.target4:SetPos(self.Entity:GetPos() + (self.Entity:GetUp() * -100) )  
			...
			self.target5:SetPos(self.Entity:GetPos() + self.Entity:GetForward() * 230 ) 
	...
	if self.CreateWingProps == 1 && speed > 1500 then
		...
		self.LeftWingProp:SetPos(self.Entity:GetPos() + (self.Entity:GetRight() * -222) + (self.Entity:GetUp() * -5) + (self.Entity:GetForward() * -230) )
		self.LeftWingProp:SetOwner(self.Owner)	
		self.LeftWingProp:SetColor(Color(0,0,0,0))
		self.LeftWingProp:Spawn()
		self.LeftWingProp:GetPhysicsObject():EnableGravity(false)
		...
		self.RightWingProp:SetPos(self.Entity:GetPos() + (self.Entity:GetRight() * 222) + (self.Entity:GetUp() * -5) + (self.Entity:GetForward() * -230) )
		self.RightWingProp:SetOwner(self.Owner)		
		self.RightWingProp:SetColor(Color(0,0,0,0))
		self.RightWingProp:Spawn()
		self.RightWingProp:GetPhysicsObject():EnableGravity(false)
	...
	if self.DieOnce == 0 && self.JetHealth < 0 then
		...
		gib:SetModel("models/military2/air/gibs/backleftwing.mdl")
		...
		gib = ents.Create( "prop_physics" )
		gib:SetModel("models/military2/air/gibs/backrightwing.mdl")	
		gib:SetColor(Color(150,150,150,255)	)				
		gib:SetPos(self.Entity:GetPos())	
		gib:SetAngles(self.Entity:GetAngles())
		gib:Spawn()
		...
		gib = ents.Create( "prop_physics" )
		gib:SetModel("models/military2/air/gibs/cockpit.mdl")
		gib:SetColor(Color(150,150,150,255)	)			
		gib:SetPos(self.Entity:GetPos())	
		gib:SetAngles(self.Entity:GetAngles())
		gib:Spawn()
		...
		gib = ents.Create( "prop_physics" )
		gib:SetModel("models/military2/air/gibs/frontwheel.mdl")
		gib:SetColor(Color(150,150,150,255)	)				
		gib:SetPos(self.Entity:GetPos())	
		gib:SetAngles(self.Entity:GetAngles())
		gib:Spawn()
		...
		gib = ents.Create( "prop_physics" )
		gib:SetModel("models/military2/air/gibs/leftwheel.mdl")	
		gib:SetColor(Color(150,150,150,255)	)				
		gib:SetPos(self.Entity:GetPos())	
		gib:SetAngles(self.Entity:GetAngles())
		gib:Spawn()		
		...
		gib = ents.Create( "prop_physics" )
		gib:SetModel("models/military2/air/gibs/leftwing.mdl")	
		gib:SetColor(Color(150,150,150,255)		)		
		gib:SetPos(self.Entity:GetPos())		
		gib:SetAngles(self.Entity:GetAngles())
		gib:Spawn()		
		...
		gib = ents.Create( "prop_physics" )
		gib:SetModel("models/military2/air/gibs/middle.mdl")
		gib:SetColor(Color(150,150,150,255)		)			
		gib:SetPos(self.Entity:GetPos())	
		gib:SetAngles(self.Entity:GetAngles())
		gib:Spawn()		
		...
		gib = ents.Create( "prop_physics" )
		gib:SetModel("models/military2/air/gibs/rightwheel.mdl")
		gib:SetColor(Color(150,150,150,255)		)		
		gib:SetPos(self.Entity:GetPos())	
		gib:SetAngles(self.Entity:GetAngles())
		gib:Spawn()			
		...
		gib = ents.Create( "prop_physics" )
		gib:SetModel("models/military2/air/gibs/rightwing.mdl")	
		gib:SetColor(Color(150,150,150,255)			)			
		gib:SetPos(self.Entity:GetPos())	
		gib:SetAngles(self.Entity:GetAngles())
		gib:Spawn()	
	...
	if self.DamageLevel == 0 && self.JetHealth < 200 then
		...
		if ranPos == 1 then
			pos =  (self.Entity:GetRight() * 150) + (self.Entity:GetUp() * -5) + (self.Entity:GetForward() * -230) 
			
		elseif ranPos == 2 then
			pos = (self.Entity:GetRight() * -150) + (self.Entity:GetUp() * -5) + (self.Entity:GetForward() * -230)
			
		elseif ranPos == 3 then
			pos = (self.Entity:GetForward() * 80 ) + ( self.Entity:GetUp() * -13 )
			
		elseif ranPos == 4 then
			pos = (self.Entity:GetForward() * 30 ) + ( self.Entity:GetUp() * -35 )
			
		elseif ranPos == 5 then
			pos = (self.Entity:GetForward() * 65 ) + ( self.Entity:GetUp() * -30 ) + (self.Entity:GetRight() * -50)
			
		elseif ranPos == 6 then
			pos = (self.Entity:GetForward() * 65 ) + ( self.Entity:GetUp() * -30 ) + (self.Entity:GetRight() * 50)
			
		elseif ranPos == 7 then
			pos = (self.Entity:GetForward() * -320) + (self.Entity:GetUp() * -5)
		end	
		
		local fire = ents.Create( "env_fire_trail" )
		fire:SetPos( self.Entity:GetPos() + pos)
		fire:Spawn()
